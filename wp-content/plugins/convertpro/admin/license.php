...
<div class="cp-license-wrap">
	<h3 class="cp-gen-set-title" ><?php esc_html_e( 'License', 'convertpro' ); ?></h3>
	...
	<?php
		...
		echo bsf_license_activation_form( $args ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
		?>
