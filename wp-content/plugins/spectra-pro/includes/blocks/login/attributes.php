 ...
 * @package spectra-pro
 */
$form_border_attribute   = UAGB_Block_Helper::uag_generate_border_attribute( 'form' );
$fields_border_attribute = UAGB_Block_Helper::uag_generate_border_attribute( 'fields' );
$login_border_attribute  = UAGB_Block_Helper::uag_generate_border_attribute( 'login' );
